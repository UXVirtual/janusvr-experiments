...
void main(void)
{
	...
	vec3 landColor = vec3(1,0,1) * (noiseB * (1.0 + diff));
	// vec3 forestColor = vec3(0.93, 0.82, 0.65);
	// vec3 mountainColor = vec3(0.93, 0.93, 0.93);
	vec3 waterColor = vec3(1,0,1);
	vec4 cloudColor = vec4(1,0,1, pow(cloud, 6.0));
